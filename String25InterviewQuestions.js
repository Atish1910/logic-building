...
const iStr2 = "MARKram";
const iPelendrome = iStr2.toLowerCase().split("").reverse().join("") == iStr2.toLowerCase() ? "Pelendrome" : "Not pelendrome";
...
const iUnique = iStr4.split("").reduce((acc, curr) => {
...
const cStr2 = "liasten";
const isAnamagram = cStr1.toLowerCase().split("").sort().join("") == cStr2.toLowerCase().split("").sort().join("") ? "string is anagram" : "not anaagram";
...
const iStr12 = "atish";
const iRemove = iStr12.split("").filter((c) => {
  return c != "h"; 
}).join("") 
console.log(iRemove);
...
const iStr0010 = "asjdg asdk hasd asdoi uas d  asdpou dpas adsp asd aspd sda poua";
...
let acronyn = iSentance.split(" ").map((word) => {
